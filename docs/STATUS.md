...
- **P1.2 — Nettoyage éditorial ciblé** : les notes de production FAQ et deux formulations internes ont été retirées. La différenciation éditoriale des pages proches reste ouverte.
...
- différencier ou consolider les contenus éditoriaux trop proches ;
