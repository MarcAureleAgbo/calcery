...
export const CALCULATORS: CalculatorDefinition[] = [
  ...
  },
  {
    ...
    category: 'finance',
    icon: '🧾',
    name: { fr: 'Impot sur le revenu', en: 'French income tax' },
    title: {
      fr: 'Estimation de l’impôt sur le revenu français 2026',
      en: 'French Income Tax Calculator — 2026 tax on 2025 income',
    },
    description: {
      fr: 'Estimez l’impôt brut 2026 sur vos revenus 2025 avec le barème français et votre nombre de parts.',
      en: 'Estimate 2026 French gross income tax on 2025 income using the French scale and your tax shares.',
    },
    metaTitle: {
      fr: 'Impôt sur le revenu 2026 (revenus 2025) | Calcery',
      en: 'French Income Tax Calculator 2026 | Calcery',
    },
    metaDescription: {
      fr: 'Estimez l’impôt brut français 2026 sur les revenus 2025, par barème progressif et nombre de parts.',
      en: 'Estimate 2026 French gross income tax on 2025 income with progressive brackets and tax shares.',
    },
    faqs: {
      fr: [
        { question: 'Quel revenu saisir ?', answer: 'Le revenu net imposable annuel du foyer, et non le salaire brut ou le net à payer.' },
        { question: 'Le quotient familial est-il entièrement pris en compte ?', answer: 'Le calcul divise le revenu par les parts saisies, mais ne calcule pas le plafonnement du quotient familial.' },
        { question: 'Pourquoi le résultat peut-il différer du simulateur officiel ?', answer: 'Le simulateur officiel tient compte de mécanismes exclus ici, comme la décote, les crédits et réductions d’impôt ou des situations particulières.' },
      ],
      en: [
        { question: 'Which income should I enter?', answer: 'Household annual net taxable income, not gross salary or take-home pay.' },
        { question: 'Is the family quotient fully included?', answer: 'The calculation divides income by entered shares but does not calculate the family-quotient cap.' },
        { question: 'Why may this differ from the official simulator?', answer: 'The official simulator applies mechanisms excluded here, including low-income relief, tax credits and reductions, and special situations.' },
      ],
    },
    tips: {
      fr: [
        'Utilisez le revenu net imposable indiqué par vos documents fiscaux.',
        'Traitez ce résultat comme un impôt brut estimé, pas comme un avis d’impôt.',
        'Utilisez le simulateur officiel pour une situation complète.',
      ],
      en: [
        'Use the net taxable income shown in your French tax records.',
        'Treat the result as an estimated gross tax, not a tax notice.',
        'Use the official simulator for a complete situation.',
      ],
    },
